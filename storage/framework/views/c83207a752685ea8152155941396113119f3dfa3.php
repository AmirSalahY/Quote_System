                    ...
                    <div class="advantages">
                        <div class="row">
                            <?php $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4">
                                    <div class="advantages__item wow fadeInUp" data-wow-duration="2s" style="text-align: justify;text-align-last: center;  text-space-trim: trim-inner;">
                                        
                                        <h3 class="advantages__title ui-title-inner"><?php echo e($quote->quote); ?></h3>
                                        <div class="advantages__description"><?php echo e($quote->author); ?></div>
